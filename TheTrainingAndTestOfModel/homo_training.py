...
train_file_path = "data/experimentalData/train/SCOP95.txt"
#train_file_path = "data/experimentalData/train/SCOPe95.txt"
...
if __name__ == "__main__":
    start_train("finalData/net/SCOP/SCOP.ckpt")
    #start_train("finalData/net/SCOPe/SCOPe.ckpt")
